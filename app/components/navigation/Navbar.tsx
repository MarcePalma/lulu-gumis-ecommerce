    ...
    const navLinks = [
        {
            ...
            path: '/catalogo',
            options: [
                { title: 'Amigurumis', path: '/catalogo?category=Amigurumis' },
                { title: 'Flores', path: '/catalogo?category=Flores' },
                { title: 'Accesorios', path: '/catalogo?category=Accesorios' },
                { title: 'Vestuario', path: '/catalogo?category=Vestuario' },
            ],
        },
    ];
